...
class User
{
    ...
    {       
        $output = shell_exec("/etc/brainy/src/compiled/php5/bin/php -q /etc/brainy/2FA/CheckPass56.php username=".escapeshellarg($this->user) . " password=".escapeshellarg($pass));
        return $output;
    }
